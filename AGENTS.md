...
- Valores de celda: `0` vacío, `1` pared, `2` dot, `3` puerta de la pen, `4` power pellet. La puerta (`3`) bloquea a todos los actores en `canMove`; los fantasmas solo la cruzan mediante la ruta guionizada de salida (`moveExiting`, que no consulta paredes).
